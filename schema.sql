...
insert into shoes (brand, display_model, nickname, colorway, sort_model, primary_color, accent_color1, accent_color2, link_nickname, style_code, size, designer, model_details, colorway_details, release_date,price, associated_athlete, forefoot_cushioning_technology, heel_cushioning_technology, type, user_id) 
values
